...
{
  new (message_memory) navigation_interfaces::msg::Spline(_init);
}

void Spline_fini_function(void * message_memory)
{
  auto typed_message = static_cast<navigation_interfaces::msg::Spline *>(message_memory);
  typed_message->~Spline();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember Spline_message_member_array[1] = {
  {
    ...
    offsetof(navigation_interfaces::msg::Spline, structure_needs_at_least_one_member),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Spline_message_members = {
  ...
  "Spline",  // message name
  1,  // number of fields
  sizeof(navigation_interfaces::msg::Spline),
...
{
  return &::navigation_interfaces::msg::rosidl_typesupport_introspection_cpp::Spline_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, navigation_interfaces, msg, Spline)() {
  return &::navigation_interfaces::msg::rosidl_typesupport_introspection_cpp::Spline_message_type_support_handle;
}
