...
#include "navigation_interfaces/msg/detail/spline__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const navigation_interfaces::msg::Spline & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  navigation_interfaces::msg::Spline & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = navigation_interfaces::msg::Spline;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_navigation_interfaces
max_serialized_size_key_Spline(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const navigation_interfaces::msg::Spline *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<navigation_interfaces::msg::Spline *>(
    untyped_ros_message);
...
{
  return &navigation_interfaces::msg::typesupport_fastrtps_cpp::_Spline__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, navigation_interfaces, msg, Spline)() {
  return &navigation_interfaces::msg::typesupport_fastrtps_cpp::_Spline__handle;
}
